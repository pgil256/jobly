...
class User {
  ...
  static async get(username) {
    ...
    user.application = userApplicationsRes.rows.map(a => a.job_id);
    return user;
  }
  ...
  //added apply to Job functionality
  static async applyToJob(username, jobId) {
    ...
    await db.query(
      `INSERT INTO application( job_id, username)
